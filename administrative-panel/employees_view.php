											...
											<div class="form_grid_12 multiline">
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="emp_full_name" id="emp_full_name" type="text" value="<?php echo $row['emp_full_name'];?>" class="large limiter" maxlength="30" tabindex="1" readonly/>
													</div>
													<div class="form_grid_6 ">
														<span class=" label_intro">Date of Birth</span>
															<input name="emp_dob" type="date" value="<?php echo $row['emp_dob'];?>" class="large limiter" tabindex="2" readonly/>
													</div>
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="emp_email" type="text" value="<?php echo $row['emp_email'];?>" class="large limiter" maxlength="100" tabindex="3" readonly/>
													</div>
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<?php
														$sql_type="SELECT id, title FROM employee_type WHERE id='".$row['emp_type']."'";
														$res_type=mysql_query($sql_type, $conn1);
														$row_type=mysql_fetch_array($res_type);
														?>
														<input name="emp_type" type="text" value="<?php echo $row_type['title'];?>" class="large limiter" tabindex="5" readonly/>
													</div>
													<div class="form_grid_6">
														<span class=" label_intro">Department</span>
														<?php
														$sql_department="SELECT id, title FROM departments WHERE id='".$row['emp_department']."'";
														$res_department=mysql_query($sql_department, $conn1);
														$row_department=mysql_fetch_array($res_department);
														?>
														<input name="emp_department" type="text" value="<?php echo $row_department['title'];?>" class="large limiter" tabindex="6" readonly/>
													</div>
													<span class="clear"></span>
												</div>
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="emp_age" type="text" value="<?php echo $row['emp_age'];?>" class="large limiter" tabindex="7" readonly/>
													</div>
													<span class="clear"></span>
												</div>
											</div>
											...
											<div class="form_grid_12 multiline">
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
															...
															<input name="emp_mobile" type="text" value="<?php echo $row['emp_mobile'];?>" class="large limiter" tabindex="8" readonly/>
													</div>
													<div class="form_grid_6 ">
															<span class=" label_intro">City</span>
															<?php
															$sql_city="SELECT id, title FROM cities WHERE id='".$row['emp_city']."'";
															$res_city=mysql_query($sql_city, $conn1);
															$row_city=mysql_fetch_array($res_city);
															?>
															<input name="emp_city" type="text" value="<?php echo $row_city['title'];?>" class="large limiter" tabindex="9" readonly/>
													</div>
													<span class="clear"></span>
												</div>
												<div class="form_input">
													<div class="form_grid_6 alpha">
															...
															<textarea name="emp_address" class="input_grow" cols="40" rows="5" tabindex="10" readonly><?php echo stripslashes($row['emp_address']);?></textarea>
													</div>
													<span class="clear"></span>
												</div>
											</div>
											...
											<div class="form_grid_12 multiline">
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="emp_user_name" id="emp_user_name" type="text" value="<?php echo $row['emp_user_name'];?>" class="large limiter" tabindex="11" disabled="disabled"/>
													</div>
													<div class="form_grid_6 ">
													</div>
													<span class="clear"></span>
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="emp_password" id="emp_password" type="password" class="large limiter" tabindex="12" readonly/>
													</div>
													<div class="form_grid_6 ">
														<span class=" label_intro">Confirm Password</span>
														<input name="emp_cpassword" id="emp_cpassword" type="password" class="large limiter" onBlur="if(document.getElementById('emp_password').value!=this.value){alert('Enter Same Passwords');document.getElementById('emp_password').value='';this.value='';document.getElementById('emp_password').focus();}" tabindex="13" readonly/>
													</div>
													<span class="clear"></span>
												</div>
											</div>
