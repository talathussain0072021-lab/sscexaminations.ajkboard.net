...
<tr>
	...
	<td style="font-size:14pt; text-align:center; width:80%; vertical-align:middle;"><b>PII ADM. BATCHES(REG) ADM. CHECK LIST '.strtoupper($ExamName).'</b></td>
...
<tr>
	...
	<td style="background-color:#D1E2F2; width:25%;"><strong>Remarks</strong></td>          	
		...
		$sql="SELECT Id, BatchNo, AdmStatus, RevStatus, StdCount, BatchFee, ChallanNo, InstituteCode FROM vwadmbatches12 WHERE BatchStatus=".$_REQUEST['BatchStatus']." AND BatchType=1 AND ExamId=".$ExamId." AND AdmStatus=".$_REQUEST['AdmRevStatus']." ORDER BY InstituteCode, Id ASC limit {$first_number}, 1000";
