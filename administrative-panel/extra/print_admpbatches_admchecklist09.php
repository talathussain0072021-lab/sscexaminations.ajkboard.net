...
<tr>
	...
	<td style="font-size:14pt; text-align:center; width:70%; vertical-align:middle;"><b>ADM. BATCHES(PRIV) ADM. CHECK LIST '.$SessionName.'</b></td>
...
<tr>
	...
	<td style="background-color:#D1E2F2; width:45%;"><strong>Remarks</strong></td>          	
</tr></table>','O');
		...
		$sql="SELECT Id, BatchNo, AdmStatus, RevStatus, StdCount, BatchFee, ChallanNo, InstituteCode FROM vwadmbatches11 WHERE BatchStatus=1 AND BatchType=2 AND SessionId=".$SessionId." AND AdmStatus=".$_REQUEST['BatchStatus']." ORDER BY InstituteCode, Id ASC limit {$first_number}, 1000";
