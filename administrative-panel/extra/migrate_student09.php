...
<div id="container">
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(mysql_query($sql, $conn1))
		{
			...
			?><script>alert('Information Processed Successfully.');location.replace('allstudents_edit09.php');</script><?php
		}
		else
		{
			?><script>alert('Error in Query.');location.replace('migrate_student09.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, CNIC, InstituteId FROM vwregstudents WHERE Id=".$_REQUEST['Id']."";
							...
							<ul>
								...
								<fieldset>
									...
									<ul>
										...
										<li>
										<div class="form_grid_6">
											<label class="field_title">Student CNIC/Form B #<span class="req">*</span></label>
											<div class="form_input">
												<input name="CNIC" id="CNIC" type="text" value="<?php echo $row['CNIC'];?>" class="x_large" disabled/>
											</div>
										</div>
										<div class="form_grid_6">
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('migrate_student09.php?Id=<?php echo $_REQUEST['Id'];?>&InstituteId=<?php echo $_REQUEST['InstituteId'];?>')" tabindex="4"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
