...
<div id="container">
	...
	<?php
	$sql1="SELECT Id FROM vwrollnoslip09s";
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						{
							$SrNo=1;
							$sql="SELECT Id, RegNo, RollNo, Name, FatherName, Gender, ExamShift, GroupId, BATCH_ID, ACentreCode, ACentreName FROM vwrollnoslip09s WHERE RollNo!=0";
							...
							<tr>
								...
								<td class="center"><a href="print_student_allcentreslips09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_medium">Centre Slip</span></a></td>
							</tr>
							<?php
							$SrNo++;
							}
