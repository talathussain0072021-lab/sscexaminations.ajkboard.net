			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						{
							$SrNo=1;
							$sql="SELECT Id, Name FROM vwadmstudents10 WHERE Id=".$_REQUEST['StudentId']." AND ExamId=".$ExamId."";
							$res=mysql_query($sql, $conn1);
							$row=mysql_fetch_array($res);
							$StudentName=$row['Name'];
							
							$sql_history="SELECT emp.emp_full_name, emplh.ActivityType, emplh.ActivityTime, emplh.ActivityDescription, emplh.ActivityRefNo FROM tbl_piilog emplh INNER JOIN employees emp ON emplh.EmployeeId=emp.emp_id WHERE StudentId=".$_REQUEST['StudentId']." ORDER BY emplh.Id DESC";
