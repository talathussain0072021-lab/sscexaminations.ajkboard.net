...
<div id="container">
	...
	{
		$updt1="UPDATE admbatchstudents09s SET
		...
		if($resupdt1==1)
		{
			...
			ActivityType			=		'ChallanFeeInfoUpdation-Is',
		...
		{
			?><script>alert('Error in Query.');location.replace('updtchallanfeeinfo_student09s.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, IsRegular, BatchNo, AdmissionFee, StdChallanId FROM vwadmstudents09s WHERE Id=".$_REQUEST['Id']."";
								...
								<fieldset>
									...
									<ul>
										...
										<div class="form_grid_6">
											...
											<div class="form_input">
												<input name="AdmissionFee" id="AdmissionFee" type="text" value="<?php echo $row['AdmissionFee'];?>" class="x_large" onkeypress="return isNumber()" maxlength="10" tabindex="1"/>
											</div>
										</div>
										<br /><br /><br />
										</li>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtchallanfeeinfo_student09s.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="4"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
