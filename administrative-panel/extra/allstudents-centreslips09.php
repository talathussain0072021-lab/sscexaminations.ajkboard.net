...
<div id="container">
	...
	<?php
	$sql1="SELECT Id FROM vwrollnoslip09";
				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td><input name="RegistrationNo" id="RegistrationNo" type="text" value="<?php echo $_REQUEST['RegistrationNo'];?>" class="admin-select limiter" onkeypress="return isNumber()" maxlength="12" tabindex="2"/></td>
						...
						<tr>
							<td colspan="6" align="left">
								...
								<a class="iframe" href="choose_std-centreslips09.php?StdudentId=<?php echo $_REQUEST['StdudentId'];?>&&RegistrationNo=<?php echo $_REQUEST['RegistrationNo'];?>&&RollNo=<?php echo $_REQUEST['RollNo'];?>&&BatchSr=<?php echo $_REQUEST['BatchSr'];?>&&Name=<?php echo $_REQUEST['Name'];?>&&CentreCode=<?php echo $_REQUEST['CentreCode'];?>"><span class="badge_style b_done">Print All Centre Slips</span></a>
							</td>
						</tr>
						</table>
						</form>
						...
						<tr>
							<td colspan="2" align="left">
								...
								<a class="iframe" href="choose_std-custcentreslips09.php?CentreCode=<?php echo $_REQUEST['CentreCode'];?>"><span class="badge_style b_done">Print All Centre Slips</span></a>
							</td>
						</tr>
						</table>
						</form>
						...
						{
							$SrNo=1;
							$sql="SELECT Id, RegistrationNo, RollNo, Name, FatherName, Gender, ExamShift, GroupId, BATCH_ID, ACentreCode, ACentreName FROM vwrollnoslip09 WHERE RollNo!=0";
							...
							<tr>
								...
								<td class="center"><a href="print_student_allcentreslips09.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_medium">Centre Slip</span></a></td>
							</tr>
							<?php
							$SrNo++;
							}
						...
						{
							$SrNo=1;
							$sql="SELECT Id, RegistrationNo, RollNo, Name, FatherName, Gender, ExamShift, GroupId, BATCH_ID, ACentreCode, ACentreName FROM vwrollnoslip09 WHERE RollNo!=0 AND ACentreCode='".$_REQUEST['CentreCode']."' ORDER BY ExamShift, RollNo ASC";
							$res=mysql_query($sql, $conn1);
							while($row=mysql_fetch_array($res))
							{
								if($row['Gender']==1){ $Gender='Male'; }
							...
							<tr>
								...
								<td class="center"><?php echo $row['ACentreCode'];?></td>
								<td class="center"><?php echo $row['ACentreName'];?></td>
								<td class="center"><a href="print_student_centreslip09.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_medium">Centre Slip</span></a></td>
							</tr>
							<?php
							$SrNo++;
							}
