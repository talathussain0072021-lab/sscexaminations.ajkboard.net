...
<div id="container">
	...
	<?php
	$sql1="SELECT COUNT(*) AS TotalStudents, COUNT(CASE WHEN IsPrinted=1 THEN 1 END) AS PrintedSlips FROM vwrollnoslip09c WHERE IsRegular=1";
					...
					<div class="widget_content">
						...
						<tr>
							<td colspan="6" align="left">
								...
								<a class="iframe" href="choose_std-rollnoslips09.php?StdudentId=<?php echo $_REQUEST['StdudentId'];?>&&RegistrationNo=<?php echo $_REQUEST['RegistrationNo'];?>&&RollNo=<?php echo $_REQUEST['RollNo'];?>&&BatchSr=<?php echo $_REQUEST['BatchSr'];?>&&Name=<?php echo $_REQUEST['Name'];?>&&CentreCode=<?php echo $_REQUEST['CentreCode'];?>&&InstituteCode=<?php echo $_REQUEST['InstituteCode'];?>&&IsRegular=1"><span class="badge_style b_done">Print All RollNo Slips</span></a>
							</td>
						</tr>
						</table>
						</form>
						...
						{
							$SrNo=1;
							$sql="SELECT Id, RegistrationNo, RollNo, Name, FatherName, Gender, ExamShift, CombinationName, BATCH_ID, IsPrinted, ACentreCode, ACentreName FROM vwrollnoslip09 WHERE IsRegular=1";
							...
							<tr>
								...
								<td class="center">
								<?php if(in_array('120801',$_SESSION['emp_user_rights'])){?>
								<span><a class="action-icons c-delete" href="delete_rollnoslips09.php?Id=<?php echo $row['Id'];?>&Type=1" title="Delete">Delete</a></span>
								<?php }?>
								</td>
