...
<?php
$sql="SELECT count(Id) as tstd_count FROM vwrollnoslip09 WHERE ACentreCode='".$_REQUEST['CentreCode']."'";
			...
			<div class="grid_12 full_block">
				...
				<!--<a href="voucher_print.php?id=<?php //echo $_REQUEST['id'];?>">
					...
					<div class="widget_content">
						...
						?>
						<tr height="40px">
							<td>-> <a href="print_student_custcentreslips09.php?CentreCode=<?php echo $_REQUEST['CentreCode'];?>&&first_number=<?php echo $first_number;?>&&last_number=<?php echo $last_number;?>" target="_blank">PRINT CENTRE SLIP FROM <?php echo $first_number.'-'.$last_number;?></a></td>
						</tr>
						<?php
						}
						?>
