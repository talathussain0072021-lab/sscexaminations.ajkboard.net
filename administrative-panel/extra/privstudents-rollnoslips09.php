...
<div id="container">
	...
	<?php
	$sql1="SELECT COUNT(*) AS TotalStudents, COUNT(CASE WHEN IsPrinted=1 THEN 1 END) AS PrintedSlips FROM vwrollnoslip09c WHERE IsRegular=0";
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Private Students-RollNo Slips <?php echo $ExamName;?></h6>
					</div>
					...
					<div class="widget_content">
						...
						<tr>
							<td colspan="6" align="left">
								<input type="submit" name="search" id="search" value="Search" tabindex="7"/>
								<a class="iframe" href="choose_std-rollnoslips09.php?StdudentId=<?php echo $_REQUEST['StdudentId'];?>&&RegistrationNo=<?php echo $_REQUEST['RegistrationNo'];?>&&RollNo=<?php echo $_REQUEST['RollNo'];?>&&BatchSr=<?php echo $_REQUEST['BatchSr'];?>&&Name=<?php echo $_REQUEST['Name'];?>&&CentreCode=<?php echo $_REQUEST['CentreCode'];?>&&IsRegular=0"><span class="badge_style b_done">Print All RollNo Slips</span></a>
							</td>
						</tr>
						</table>
						</form>
						...
						{
							$SrNo=1;
							$sql="SELECT Id, RegistrationNo, RollNo, Name, FatherName, Gender, ExamShift, CombinationName, BATCH_ID, IsPrinted, ACentreCode, ACentreName FROM vwrollnoslip09 WHERE IsRegular=0";
							...
							<tr>
								...
								<td class="center">
								<?php if(in_array('120901',$_SESSION['emp_user_rights'])){?>
								<span><a class="action-icons c-delete" href="delete_rollnoslips09.php?Id=<?php echo $row['Id'];?>&Type=0" title="Delete">Delete</a></span>
								<?php }?>
								</td>
								<td class="center"><a href="print_student_allrollnoslips09.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_medium">RollNo Slip</span></a></td>
							</tr>
							<?php
							$SrNo++;
							}
