...
<div id="container">
	...
	if(mysql_query($sql, $conn1))
	{
		...
		?><script>alert('Information Processed Successfully.');location.replace('allstudents_radm10.php');</script><?php
	}
	else
	{
		?><script>alert('Error in Query.');location.replace('allstudents_radm10.php');</script><?php
	}
	?>
</div>
