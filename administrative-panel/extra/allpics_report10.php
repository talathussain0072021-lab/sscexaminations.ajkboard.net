			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>All Pictures Report HSSC PII</h6>
					</div>
					...
					<div class="widget_content">
						...
						<tr>
							<td colspan="3"> 
								<a class="iframe" href="choose_pics12.php?InstituteId=<?php echo $_REQUEST['InstituteId'];?>"><span class="badge_style b_done">Print Report</span></a>
							</td>
						</tr>
						</form>
						</table>
