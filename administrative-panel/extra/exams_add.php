...
<div id="container">
	...
	if(isset($_REQUEST['submit']))
	{
		...
		$Dated = gmdate("Y-m-d", time()+($ms));
		
		$sql1="SELECT * FROM exams WHERE Name='".$_REQUEST['Name']."'";
		...
		else
		{
			...
			{
				?><script>location.replace('exams.php?message=Data Inserted Successfully.');</script><?php
			}
			else
			{
				?><script>alert('Error in Query.');location.replace('exams_add.php');</script><?php
			}
		}
	}
	?>
						...
						<form action="" method="post" class="form_container left_label" onSubmit="return check_submit_form();">
							<ul>
								...
								<div class="form_grid_6">
									...
									<div class="form_input">
										<input name="FullName" id="FullName" type="text" data-required="required" data-message="Enter Full Name" class="x_large" maxlength="50" tabindex="2"/>
									</div>
								</div>
								<br /><br /><br />
								</li>
								...
								<div class="form_grid_6">
									...
									<div class="form_input">
										<input name="Year" id="Year" type="text" data-required="required" data-message="Enter Year" class="x_large" maxlength="2" onkeypress="return isNumber(event)" tabindex="3"/>
									</div>
								</div>
								<div class="form_grid_6">
								...
								<div class="form_grid_6">
									...
									<div class="form_input">
										<input name="ProcessingFee" id="ProcessingFee" type="text" data-required="required" data-message="Enter Processing Fee" class="x_large" maxlength="10" onkeypress="return isNumberKey(event)" tabindex="6"/>
									</div>
								</div>
								<br /><br /><br />
								</li>
								...
								<div class="form_grid_6">
									...
									<div class="form_input">
										<input name="SubjChFee" id="SubjChFee" type="text" data-required="required" data-message="Enter SubjChange Fee" class="x_large" maxlength="10" onkeypress="return isNumberKey(event)" tabindex="7"/>
									</div>
								</div>
								<div class="form_grid_6">
									<label class="field_title">GroupChange Fee<label style="color:#FF0000"> *</label></label>
									<div class="form_input">
										<input name="GroupChFee" id="GroupChFee" type="text" data-required="required" data-message="Enter GroupChange Fee" class="x_large" maxlength="10" onkeypress="return isNumberKey(event)" tabindex="8"/>
									</div>
								</div>
								<br /><br /><br />
								</li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<button type="submit" name="submit" value="submit" class="btn_small btn_blue" tabindex="9"><span>Submit</span></button>
