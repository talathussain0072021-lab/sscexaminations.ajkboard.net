...
<div id="container">
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(mysql_query($sql, $conn1))
		{
			...
			{
				$sql1="UPDATE institutes SET
				Password		=	'".trim($_REQUEST['Password'])."',
				EnPassword		=	'".md5(trim($_REQUEST['Password']))."'
				WHERE Id		=	".$_REQUEST['Id']."";
				$res1=mysql_query($sql1, $conn1);
			}
			?><script>alert('Information Updated Successfully.');location.replace('institutes.php');</script><?php
		}
		else
		{
			?><script>alert('Error in Query.');location.replace('institutes_edit.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
											...
											<div class="form_grid_12 multiline">
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="Principal" id="Principal" type="text" value="<?php echo $row['Principal'];?>" class="limiter" maxlength="50" tabindex="5"/>
													</div>
													<div class="form_grid_6 ">
														<span class=" label_intro">Operator</span>
														<input name="Operator" id="Operator" type="text" value="<?php echo $row['Operator'];?>" class="limiter" maxlength="50" tabindex="6"/>
													</div>
													<span class="clear"></span>
												</div>
											</div>
											...
											<div class="form_grid_12 multiline">
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="ContactNo" id="ContactNo" type="text" value="<?php echo $row['ContactNo'];?>" class="limiter" onkeypress="return isNumber()" maxlength="15" tabindex="7"/>
													</div>
													<div class="form_grid_6 ">
														<span class=" label_intro">Fax</span>
														<input name="Fax" id="Fax" type="text" value="<?php echo $row['Fax'];?>" class="limiter" maxlength="15" tabindex="8"/>
													</div>
													<span class="clear"></span>
												</div>
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="Email" id="Email" type="text" value="<?php echo $row['Email'];?>" class="limiter" maxlength="50" tabindex="9"/>
													</div>
													<div class="form_grid_6 ">
												...
												<div class="form_input">
													...
													<div class="form_grid_6 ">
														...
														<textarea name="Address" id="Address" class="input_grow" cols="50" rows="5" maxlength="200" tabindex="12"><?php echo $row['Address'];?></textarea>
													</div>
													<span class="clear"></span>
												</div>
											</div>
											...
											<div class="form_grid_12 multiline">
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="Code" id="Code" type="text" value="<?php echo $row['Code'];?>" class="limiter" onkeypress="return isNumber()" maxlength="4" tabindex="15" disabled="disabled"/>
													</div>
													<div class="form_grid_6 ">
													</div>
													<span class="clear"></span>
												...
												<div class="form_input">
													<div class="form_grid_6 alpha">
														...
														<input name="Password" id="Password" type="password" class="limiter" maxlength="30" tabindex="16"/>
													</div>
													<div class="form_grid_6 ">
														<span class=" label_intro">Confirm Password</span>
														<input name="CPassword" id="CPassword" type="password" onBlur="if(document.getElementById('Password').value!=this.value){alert('Enter Same Passwords');document.getElementById('Password').value='';this.value='';document.getElementById('Password').focus();}" maxlength="30" tabindex="17"/>
													</div>
													<span class="clear"></span>
												</div>
											</div>
								...
								<ul>
									...
									<div class="form_grid_12">
										<div class="form_input">
											...
											<button type="submit" name="submit" value="submit" class="btn_small btn_blue" tabindex="18"><span>Update</span></button>
...
function check_submit_form()
{
	...
	if(document.getElementById('Password').value!='')
	{
		...
		if(CPassword=='')
		{ alert('Confirm Password'); document.getElementById('CPassword').focus(); return false; }
	}
}//check_submit_form()
</script>