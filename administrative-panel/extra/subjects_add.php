...
<div id="container">
	...
	{
		$sql1="SELECT * FROM subjects WHERE Name='".$_REQUEST['Name']."'";
		...
		else
		{
			...
			{
				?><script>location.replace('subjects.php?message=Data Inserted Succesfully.');</script><?php
			}
			else
			{
				?><script>alert('Error in Query.');location.replace('subjects_add.php');</script><?php
			}
		}
	}
	?>
						...
						<form action="" method="post" class="form_container left_label" onSubmit="return check_submit_form();">
							<ul>
								...
								<div class="form_grid_6">
									...
									<div class="form_input">
										<input name="SmallName" id="SmallName" type="text" data-required="required" data-message="Enter Small Name" class="x_large" maxlength="10" tabindex="2"/>
									</div>
								</div>
								<br /><br /><br />
								</li>
								...
								<div class="form_grid_6">
									...
									<div class="form_input">
										<input name="Code" id="Code" type="text" data-required="required" data-message="Enter Code" class="x_large" onkeypress="return isNumber()" maxlength="3" tabindex="3"/>
									</div>
								</div>
								<div class="form_grid_6">
								...
								<div class="form_grid_12">
									<div class="form_input">
										<button type="submit" name="submit" value="submit" class="btn_small btn_blue" tabindex="8"><span>Submit</span></button>
