...
<?php
$sql="SELECT count(Id) as tbatch_count FROM vwadmbatches11 WHERE BatchStatus=1 AND BatchType=2 AND SessionId=".$_REQUEST['SessionId']." AND AdmStatus=".$_REQUEST['BatchStatus']."";
					...
					<div class="widget_content">
							<table height="200px" width="70%" style="margin-left:20px;" class="tablarge_property">
								...
								{ 
									...
									?>
									<tr height="50px">
									<td align="left" colspan="4" style="font-weight:bolder; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px;">-> <a href="#" onclick="parent.jQuery.colorbox.close();window.open('print_admpbatches_admlist11.php?BatchStatus=<?php echo $_REQUEST['BatchStatus'];?>&first_number=<?php echo $first_number;?>&&last_number=<?php echo $last_number;?>','_parent');">PRINT RECORD FROM <?php echo $first_number.'-'.$last_number;?></a></td>
									</tr>
								<?php	
								}
								?>
