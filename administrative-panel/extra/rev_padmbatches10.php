					...
					<div class="widget_content">
						...
						<div class="invoice_action_bar" style="float: right;">
							<div class="btn_30_blue">
								<a href="rev_padmbatches_add10.php"><span class="icon add_co"></span>
						...
						$sql="SELECT Id, BatchNo, BatchStatus, AdmStatus, RevStatus, BatchCounter, InstituteId, BatchFee, ChallanNo FROM vwadmbatches10 WHERE BatchStatus=1 AND BatchType=2 AND RevStatus=0 AND ExamId=".$ExamId." ORDER BY Id ASC";
