...
<div id="container">
	...
	<?php
	$sql1="SELECT COUNT(*) AS TotalStudents, COUNT(CASE WHEN IsPrinted=1 THEN 1 END) AS PrintedSlips FROM vwrollnoslip09sc WHERE IsRegular=1";
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						{
							$SrNo=1;
							$sql="SELECT Id, RegNo, RollNo, Name, FatherName, Gender, ExamShift, CombinationName, BATCH_ID, IsPrinted, ACentreCode, ACentreName FROM vwrollnoslip09s WHERE IsRegular=1";
							...
							<tr>
								...
								<span><a class="action-icons c-delete" href="delete_rollnoslips092A.php?Id=<?php echo $row['Id'];?>&Type=1" title="Delete">Delete</a></span>
								<?php }?>
								</td>
