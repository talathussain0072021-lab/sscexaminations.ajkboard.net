			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Adm. Batches(Regular) Check List <?php echo $ExamName;?></h6>
					</div>
						...
						<div style="width:100%; padding:10px;">
							...
							<tr>
								<td colspan="5" style="vertical-align:middle;">
									<a class="iframe" href="choose_admrbatches_checklist12.php?id=1&ExamId=<?php echo $ExamId;?>&BatchStatus=<?php echo $_REQUEST['BatchStatus'];?>&AdmRevStatus=<?php echo $_REQUEST['AdmRevStatus'];?>"><span class="badge_style b_done">Print Adm. Check List Report</span></a>
									<a class="iframe" href="choose_admrbatches_checklist12.php?id=2&ExamId=<?php echo $ExamId;?>&BatchStatus=<?php echo $_REQUEST['BatchStatus'];?>&AdmRevStatus=<?php echo $_REQUEST['AdmRevStatus'];?>"><span class="badge_style b_done">Print Rev. Check List Report</span></a>
									<br /><br /><a class="iframe" href="choose_admrbatches_checklist12.php?id=3&ExamId=<?php echo $ExamId;?>&BatchStatus=<?php echo $_REQUEST['BatchStatus'];?>&AdmRevStatus=<?php echo $_REQUEST['AdmRevStatus'];?>"><span class="badge_style b_done">Print Rev. Check List Report(Finance)</span></a>
								</td>
							</tr>
							<tr><td colspan="5"><br /></td></tr>
							</table>
