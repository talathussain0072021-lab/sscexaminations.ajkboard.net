...
<div id="container">
	...
	{
		$sql="UPDATE admbatchstudents09 SET
		...
		if(mysql_query($sql, $conn1))
		{
			...
			ActivityType			=		'CentreInfoUpdation-I',
		...
		{
			?><script>alert('Error in Query.');location.replace('updtcentreinfo_student09.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, ACentreId, ACentreName, ACentreCode FROM vwadmstudents09 WHERE Id=".$_REQUEST['Id']."";
									...
									<ul>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtcentreinfo_student09.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="4"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
...
<script type="text/javascript" src="js/centre-updation09.js"></script>