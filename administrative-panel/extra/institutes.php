...
<div id="container">
	...
	if(isset($_REQUEST['action'])&&$_REQUEST['action']=='update')
	{
		...
		?><script>location.replace('institutes.php?message=Data Updated Successfully.');</script><?php
	}
	?>
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>All Institutes</h6>
					</div>

					<div class="widget_content">
						
						<p class="dataTables_length" style="float: left; margin: 0px;"><br>List of All Institutes.</p>
						<div class="invoice_action_bar" style="float: right;">
							<div class="btn_30_blue">
								<a href="institutes_add.php"><span class="icon add_co"></span><span class="btn_link">Add Institute</span></a>
							</div>
						</div>
						...
						<?php
						$SrNo=1;
						$sql="SELECT * FROM institutes ORDER BY Code ASC";
						...
						while($row=mysql_fetch_array($res))
						{
							...
							if($row['IsSpecial'] == 1){ $IsSpecial='Yes'; }
							else if($row['IsSpecial']== 0){ $IsSpecial='No'; }
						...
						<tr>
							...
							<td class="center"><?php echo $row['ContactNo'];?></td>
							...
							<td class="center">
								<span><a class="action-icons c-edit" href="institutes_edit.php?Id=<?php echo $row['Id'];?>" title="Edit">Edit</a></span><!--<span><a class="action-icons c-delete" onClick="return confirm('Are you sure you want to delete this?');" href="institutes_delete.php?Id=<?php echo $row['Id'];?>" title="Delete">Delete</a></span>--><span><a class="action-icons c-approve" href="institutes_view.php?Id=<?php echo $row['Id'];?>" title="View">View</a></span>
							</td>
						</tr>
						<?php
						$SrNo++;
...
{
	location.replace('institutes.php?Id='+Id+'&IsActive='+IsActive+'&action=update');
}
</script>