...
<tr>
	...
	<td style="font-size:14pt; text-align:center; width:70%; vertical-align:middle;"><b>INSTITUTES REPORT</b></td>
...
<tr>
	...
	<td style="background-color:#D1E2F2; width:70%;"><strong>Name</strong></td>
...
//<div style="background-color:#CCC; text-align:center; padding-top:8px;" height="30px" ><span style="font-size:20px"><b>General Sale Report</b></span><div style="font-size:12px; text-align:right; margin-right:15px; margin-top:-10px;"><strong>Sale Period=</strong>'.date('d-m-Y',strtotime($_REQUEST['start_date'])).' to ' .date('d-m-Y',strtotime($_REQUEST['end_date'])).'</div></div>';
		...
		$srno=1;
		$sql="SELECT Name, Code, District FROM institutes WHERE Name is Not NULL AND Name NOT LIKE 'PRIVATE%' ORDER BY District, Code ASC";
		...
		{	
			...
			$html.='<tr>
						...
						<td style="width:70%; text-align:left;">'.$row['Name'].'</td>
