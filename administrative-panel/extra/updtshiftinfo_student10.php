...
<div id="container">
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(mysql_query($sql, $conn1))
		{
			...
			ActivityType			=		'ShiftInfoUpdation-II',
		...
		{
			?><script>alert('Error in Query.');location.replace('updtshiftinfo_student10.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, ExamShift FROM vwadmstudents10 WHERE Id=".$_REQUEST['Id']."";
									...
									<ul>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtshiftinfo_student10.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="4"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
