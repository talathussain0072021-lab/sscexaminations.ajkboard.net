			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Search Log for Challan Refund</h6>
					</div>
					...
					<div class="widget_content">
						...
						{
							$SrNo=1;
							$sql="SELECT Id, ActivityTime, ActivityType, ActivityRefNo, ChallanNo, EmployeeId FROM log_challanrefund Where ChallanNo=".$_REQUEST['ChallanNo']."";
