...
<div id="container">
	...
	if(isset($_REQUEST['action'])&&$_REQUEST['action']=='update-status')
	{
		...
		?><script>location.replace('lock_radmbatches10.php?message=Data Updated Successfully.');</script><?php
	}
	?>
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						$sql="SELECT Id, Dated, BatchNo, BatchStatus, AdmStatus, RevStatus, BatchCounter, InstituteId, StdCount, ChallanNo FROM vwadmbatches10 WHERE BatchStatus=1 AND BatchType=1 AND ExamId=".$ExamId." ORDER BY Id ASC";
						$res=mysql_query($sql, $conn1);
...
{
	location.replace('lock_radmbatches10.php?Id='+Id+'&InstituteId='+InstituteId+'&action=update-status');
}
</script>