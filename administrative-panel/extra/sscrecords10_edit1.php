...
<div id="container">
	...
	if(isset($_REQUEST['submit']))
	{
		...
		{
			?><script>alert('Error in Query.');location.replace('sscrecords10_edit1.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
								...
								<fieldset>
									...
									<ul>
										...
										<fieldset>
											...
											<ul>
												...
												<tr>
													...
													<td>
														<select name="Sub8_Pass" id="Sub8_Pass" data-message="Choose Status" class="chzn-select small-select" tabindex="34">
														<option value="">Select</option>
														<option value="PASS">PASS</option>
														<option value="FAIL">FAIL</option>
														</select>
													</td>
													<td><label style="font-weight:bold;">SUB28.</label></td>
													<td>
														<input name="Sub28_Name" id="Sub28_Name" type="text" class="x_large" readonly/>
														<input name="Sub28_Code" id="Sub28_Code" type="hidden"/>
													</td>
													<td>
														<select name="Sub28_Pass" id="Sub28_Pass" data-message="Choose Status" class="chzn-select small-select" tabindex="35">
														<option value="">Select</option>
														<option value="PASS">PASS</option>
														<option value="FAIL">FAIL</option>
														</select>
													...
													<td></td>
													<td>
														<select name="S8_Pass" id="S8_Pass" data-message="Choose Status" class="chzn-select small-select" tabindex="36">
														<option value="">Select</option>
														<option value="PASS">PASS</option>
														<option value="FAIL">FAIL</option>
														</select>
										...
										<div class="form_grid_6">
											...
											<div class="form_input">
												<select name="Result" id="Result" data-required="required" data-message="Choose Result" class="chzn-select small-select" tabindex="37">
												<option value="">Select</option>
										...
										<div class="form_grid_6">
											...
											<div class="form_input">
												<input name="AttemptLimit" id="AttemptLimit" type="text" data-required="required" data-message="Enter Attempt Limit" value="<?php echo $row['ATTEMPT_LIMIT'];?>" class="x_large" onkeypress="return isNumber()" maxlength="3" tabindex="38"/>
											</div>
										</div>
										<br /><br />
										</li>
										...
										<div class="form_grid_6">
											...
											<div class="form_input">
												<input name="ActivityRefNo" id="ActivityRefNo" type="text" data-required="required" data-message="Enter Letter No" class="x_large" maxlength="50" tabindex="39"/>
											</div>
										</div>
										<br /><br />
										</li>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="submit" name="submit" value="submit" class="btn_small btn_blue" tabindex="40"><span>Update</span></button>
												<button type="reset" class="btn_small btn_blue" onclick="location.replace('sscrecords10_edit1.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="41"><span>Reset</span></button>
											</div>
