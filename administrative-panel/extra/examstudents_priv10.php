...
<div id="container">
	...
	<?php
	$sql1="SELECT Id FROM vwadmstudents10 WHERE IsRegular=0 AND StdAdmStatus=1 AND ExamId=".$ExamId." AND BatchId is Not NULL";
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						{
							$SrNo=1;
							$sql="SELECT Id, P1RegNo, PRegNo, Dated, Name, FatherName, PicURL, Gender, Domicile, CombinationName, GroupName, BatchNo, BatchSr, ACentreCode FROM vwadmstudents10 WHERE IsRegular=0 AND StdAdmStatus=1 AND ExamId=".$ExamId."";
