...
<tr>
	...
	<td style="font-size:14pt; text-align:center; width:70%; vertical-align:middle;"><b>CENTRES SUMMARY REPORT (GROUP WISE)</b></td>
...
<tr>
	...
	<td style="background-color:#D1E2F2; width:30%;"><strong>Centre Name</strong></td>
	<td style="background-color:#D1E2F2; width:10%;"><strong>Total</strong></td>
	...
	<td style="background-color:#D1E2F2; width:5%;"><strong>Female</strong></td>           	
		...
		while($row=mysql_fetch_array($res))
		{
			...
			$html.='<tr>
						...
						<td style="width:30%; text-align:left;">'.$row['CENTRE NAME'].'</td>
