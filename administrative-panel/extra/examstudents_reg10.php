...
<div id="container">
	...
	<?php
	$sql1="SELECT Id FROM vwadmstudents10 WHERE IsRegular=1 AND StdAdmStatus=1 AND ExamId=".$ExamId." AND BatchId is Not NULL";
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td>
								...
								<option value="All">All</option>
								<?php
								$sql_batch="SELECT Id, BatchNo FROM vwadmbatches10 WHERE BatchType=1 AND ExamId=".$ExamId." ORDER BY BatchNo ASC";
						...
						{
							$SrNo=1;
							$sql="SELECT Id, P1Year, P1RollNo, P1Session, P1RegNo, P1Board, Dated, Name, FatherName, PicURL, Gender, CombinationName, GroupName, BatchNo, BatchSr, ACentreCode, InstituteCode, InstituteName FROM vwadmstudents10 WHERE IsRegular=1 AND StdAdmStatus=1 AND ExamId=".$ExamId."";
