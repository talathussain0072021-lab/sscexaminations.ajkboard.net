			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Adm. Batches(Regular) List <?php echo $SessionName;?></h6>
					</div>
					...
					<div class="widget_content">
						<div style="width:100%; padding:10px;">
							...
							<tr>
								<td colspan="3" style="vertical-align:middle;">
									<a class="iframe" href="choose_admrbatches_admlist11.php?SessionId=<?php echo $SessionId;?>&SessionName=<?php echo $SessionName;?>&BatchStatus=<?php echo $_REQUEST['BatchStatus'];?>"><span class="badge_style b_done">Print Report</span></a>
								</td>
							</tr>
							<tr><td colspan="3"><br /></td></tr>
							</table>
                        ...
                        <?php 
						$SrNo=1; $BatchSum=0;
						$sql="SELECT Id, BatchNo, BatchStatus, AdmStatus, RevStatus, BatchCounter, StdCount, BatchFee FROM vwadmbatches11 WHERE BatchStatus=1 AND BatchType=1 AND AdmStatus=".$_REQUEST['BatchStatus']." AND SessionId=".$SessionId." ORDER BY Id ASC";
