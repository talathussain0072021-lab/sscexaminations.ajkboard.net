...
<?php
$sql="SELECT count(Id) as tstd_count FROM vwcutlist09 WHERE RollNo!=0";
			...
			<div class="grid_12 full_block">
				...
				<!--<a href="voucher_print.php?id=<?php //echo $_REQUEST['id'];?>">
					...
					<div class="widget_content">
						...
						?>
						<tr height="40px">
							<td>-> <a href="print_student_cutlist09.php?StdudentId=<?php echo $_REQUEST['StdudentId'];?>&&RegistrationNo=<?php echo $_REQUEST['RegistrationNo'];?>&&RollNo=<?php echo $_REQUEST['RollNo'];?>&&BatchSr=<?php echo $_REQUEST['BatchSr'];?>&&Name=<?php echo $_REQUEST['Name'];?>&&first_number=<?php echo $first_number;?>&&last_number=<?php echo $last_number;?>" target="_blank">PRINT RECORD FROM <?php echo $first_number.'-'.$last_number;?></a></td>
						</tr>
						<?php
						}
						?>
