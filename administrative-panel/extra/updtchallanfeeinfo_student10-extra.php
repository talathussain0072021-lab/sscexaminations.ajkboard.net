...
<div id="container">
	...
	{
		$updt1="UPDATE admbatchstudents10 SET
		...
		if($resupdt1==1)
		{
			...
			ActivityType			=		'ChallanFeeInfoUpdation-II',
		...
		{
			?><script>alert('Error in Query.');location.replace('updtchallanfeeinfo_student10.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, IsRegular, BatchNo, AdmissionFee, StdChallanId FROM vwadmstudents10 WHERE Id=".$_REQUEST['Id']."";
									...
									<ul>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtchallanfeeinfo_student10.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="4"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
