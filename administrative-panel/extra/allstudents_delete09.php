				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						if(isset($_REQUEST['search']))
						{
							...
							{
								$sql_sscboards="SELECT Name FROM boards WHERE Id=".$row['SSCBoard']."";
							...
							<tr>
								...
								<td class="center">
								<?php if($row['IsRegistered']==1){?><span class="badge_style b_done">Yes</span><?php }
								else{?><span class="badge_style b_pending">No</span><?php }?>
								</td>
								...
								<td class="center">
								<?php if($row['IsRegistered']!=1 || $_SESSION['emp_id']==1 || $_SESSION['emp_id']==5 || $_SESSION['emp_id']==2){?>
								<span><a class="action-icons c-delete" href="delete_student09.php?Id=<?php echo $row['Id'];?>" title="Delete">Delete</a></span>
								<?php }?>
								</td>
							</tr>
							<?php
