...
$sql="SELECT Id, RollNo, Name, FatherName, Gender, ExamShift, GroupId, PicURL, IdentityMarks, BATCH_ID, ACentreCode, ACentreName, PostalAddress FROM vwrollnoslip10 WHERE RollNo!=0";
