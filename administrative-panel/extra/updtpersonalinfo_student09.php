...
<div id="container">
	...
	if(isset($_REQUEST['submit']))
	{
		...
		if(mysql_query($sql, $conn1))
		{
			...
			ActivityType			=		'PersonalInfoUpdation-I',
		...
		{
			?><script>alert('Error in Query.');location.replace('updtpersonalinfo_student09.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, DOB, CNIC, Gender, Religion, IdentityMarks, IsSpecial, AdmissionType FROM vwregstudents WHERE Id=".$_REQUEST['Id']."";
								...
								<fieldset>
									...
									<ul>
										...
										<div class="form_grid_6">
											...
											<div class="form_input">
												<input name="Gender" id="Gender" type="text" value="<?php echo $Gender;?>" data-required="required" class="x_large" tabindex="5" readonly/>
											</div>
										</div>
										<?php } else {?>
										<li>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtpersonalinfo_student09.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="11"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
...
function check_submit_form()
{
	...
	var ThresholdDate = new Date("<?php echo $P1DOBThreshold;?>");
