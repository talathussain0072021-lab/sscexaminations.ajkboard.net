...
$Counter=1;
$sql="SELECT Id, RollNo, Name, FatherName, Gender, ExamShift, GroupId, PicURL, IdentityMarks, BATCH_ID, ACentreName, PostalAddress FROM vwrollnoslip09 WHERE ACentreCode='".$_REQUEST['CentreCode']."' ORDER BY ExamShift, RollNo ASC limit {$first_number}, 500";
