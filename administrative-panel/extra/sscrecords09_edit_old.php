...
<div id="container">
	...
	{
		$sql_comb="SELECT Name, GroupName FROM vwsubcombinations10 WHERE Id=".$_REQUEST['CombinationId']."";
		...
		CombinationName	=	'".$row_comb['Name']."',
		GroupName		=	'".$row_comb['GroupName']."',
		Subject1Id		=	".$_REQUEST['Sub1_Id'].",
		Sub1Code		=	'".$_REQUEST['Sub1_Code']."',
		Subject2Id		=	".$_REQUEST['Sub2_Id'].",
		Sub2Code		=	'".$_REQUEST['Sub2_Code']."',
		Subject3Id		=	".$_REQUEST['Sub3_Id'].",
		Sub3Code		=	'".$_REQUEST['Sub3_Code']."',
		Subject4Id		=	".$_REQUEST['Sub4_Id'].",
		Sub4Code		=	'".$_REQUEST['Sub4_Code']."',
		Subject5Id		=	".$_REQUEST['Sub5_Id'].",
		Sub5Code		=	'".$_REQUEST['Sub5_Code']."',
		Subject6Id		=	".$_REQUEST['Sub6_Id'].",
		Sub6Code		=	'".$_REQUEST['Sub6_Code']."',
		Subject7Id		=	".$_REQUEST['Sub7_Id'].",
		Sub7Code		=	'".$_REQUEST['Sub7_Code']."',
		Subject8Id		=	".$_REQUEST['Sub8_Id'].",
		Sub8Code		=	'".$_REQUEST['Sub8_Code']."',
		Subject9Id		=	".$_REQUEST['Sub9_Id'].",
		Sub9Code		=	'".$_REQUEST['Sub9_Code']."',
		Sub21Code		=	'".$_REQUEST['Sub21_Code']."',
		Sub22Code		=	'".$_REQUEST['Sub22_Code']."',
		Sub23Code		=	'".$_REQUEST['Sub23_Code']."',
		Sub24Code		=	'".$_REQUEST['Sub24_Code']."',
		Sub25Code		=	'".$_REQUEST['Sub25_Code']."',
		Sub26Code		=	'".$_REQUEST['Sub26_Code']."',
		Sub27Code		=	'".$_REQUEST['Sub27_Code']."',
		Sub28Code		=	'".$_REQUEST['Sub28_Code']."',
		Sub29Code		=	'".$_REQUEST['Sub29_Code']."'
		WHERE Id		=	".$_REQUEST['Id']."";
		$res1=mysql_query($sql1, $conn1) or die(mysql_error());
		...
		S4_CODE			=	'".$_REQUEST['Sub4_Code']."',
		S4_PASS			=	'".$_REQUEST['Sub4_Pass']."',
		...
		$res2=mysql_query($sql2, $conn1)or die(mysql_error());
	...
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, RegistrationNo, RESULT FROM vwstudentspi WHERE Id=".$_REQUEST['Id']."";
	$res=mysql_query($sql, $conn1);
	$row=mysql_fetch_array($res);
	
	$sql1="SELECT ID FROM tbl_resultpi WHERE REGNO='".$row['RegistrationNo']."'";
	$res1=mysql_query($sql1, $conn1);
										...
										<fieldset>
											...
											<ul>
												...
												<tr>
													...
													<td>
														<select name="Sub4_Pass" id="Sub4_Pass" data-required="required" data-message="Choose Status" class="chzn-select small-select" tabindex="6">
														<option value="">Select</option>
														<option value="PASS">PASS</option>
														<option value="FAIL">FAIL</option>
														</select>
