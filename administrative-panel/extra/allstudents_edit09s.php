				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td><input name="Name" id="Name" type="text" value="<?php echo $_REQUEST['Name'];?>" class="admin-select limiter" tabindex="9"/></td>
						</tr>
						<tr>
							<td><strong>CNIC:</strong></td>
							<td><input name="CNIC" id="CNIC" type="text" value="<?php echo $_REQUEST['CNIC'];?>" class="admin-select limiter" maxlength="10" tabindex="14"/></td>
							<td><strong>Institute:</strong></td>
							<td>
								<select name="InstituteId" Id="InstituteId" data-placeholder="Select Institute" class="chzn-select admin-select" tabindex="11"/>
								<option value="">Select</option>
								<?php
							...
							<td>
								<select name="AdmBatchId" id="AdmBatchId" data-placeholder="Select BatchNo" class="chzn-select admin-select" tabindex="12"/>
								<option value="">Select</option>
								<?php
						...
						<tr>
							...
							<td>
								<input name="AdmBatchSr" id="AdmBatchSr" type="text" value="<?php echo $_REQUEST['AdmBatchSr'];?>" class="admin-select" maxlength="10" tabindex="13"/>
							</td>
							<td><strong>RollNo New:</strong></td>
							<td>
								<input name="RollNo" id="RollNo" type="text" value="<?php echo $_REQUEST['RollNo'];?>" class="admin-select" onkeypress="return isNumber()" maxlength="6" tabindex="14"/>
							</td>
						</tr>
						<tr>
							<td colspan="6"><input type="submit" name="search" id="search" value="Search" tabindex="15"/></td>
						</tr>
						</table>
						</form>
						...
						{
							$SrNo=1;
							$sql="SELECT Id, P1Year, P1RollNo, P1Session, P1RegNo, P1Board, Dated, Name, FatherName, PicURL, Gender, IsSpecial, IsRegular, AdmCategory, SubCategory, InstituteId, CombinationName, GroupName, BatchNo, BatchSr, StdInstituteCode, StdInstituteName FROM vwadmstudents09s WHERE ExamId=".$ExamId."";
							...
							{ $sql.=" AND P1RegNo='".$_REQUEST['RegNo']."'"; }
							...
							<tr>
								...
								<a href="updtpic_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update Pic</span></a>
								<?php }?>
								</td>
								<td class="center">
								<?php if(in_array('170102',$_SESSION['emp_user_rights'])){?>
								<a href="updtgrpcomb_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update Grp/Comb</span></a>
								<?php }?>
								</td>
								<td class="center">
								<?php if(in_array('170103',$_SESSION['emp_user_rights'])){?>
								<a href="updtmedium_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update Medium</span></a>
								<?php }?>
								</td>
								<td class="center">
								<?php if(in_array('170104',$_SESSION['emp_user_rights'])){?>
								<a href="updtbasicinfo_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update BInfo</span></a>
								<?php }?>
								</td>
								<td class="center">
								<?php if(in_array('170105',$_SESSION['emp_user_rights'])){?>
								<a href="updtpersonalinfo_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update PInfo</span></a>
								<?php }?>
								</td>
								<td class="center">
								<?php if(in_array('170106',$_SESSION['emp_user_rights'])){?>
								<a href="updtcontactinfo_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update ContInfo</span></a>
								<?php }?>
								</td>
								<td class="center">
								<?php if(in_array('170107',$_SESSION['emp_user_rights'])){?>
								<a href="updtcentreinfo_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update CentreInfo</span></a>
								<?php }?>
								</td>
								<td class="center">
								<?php if(in_array('170108',$_SESSION['emp_user_rights'])){?>
								<a href="updtshiftinfo_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update ShiftInfo</span></a>
								<?php }?>
								</td>
								<!--<td class="center">
								<?php if(in_array('170109',$_SESSION['emp_user_rights'])){?>
								<a href="updtchallanfeeinfo_student09s.php?Id=<?php echo $row['Id'];?>" target="_blank"><span class="badge_style b_high">Update Challan/FeeInfo</span></a>
								<?php }?>
								</td>-->
							</tr>
							<?php
