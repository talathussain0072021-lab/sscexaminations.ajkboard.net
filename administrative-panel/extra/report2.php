			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Reg. Batch(All Students) <?php echo $SessionName;?></h6>
					</div>
					...
					<div class="widget_content">
                        ...
                        <?php 
						$SrNo=1;
						$sql="SELECT Id, BatchNo, BatchStatus, RegStatus, RevStatus, BatchCounter, InstituteId, StdCount, BatchFee, ChallanNo FROM vwregbatches WHERE BatchStatus=1 AND SessionId=".$SessionId."";
						...
						<tr>
							...
							<td class="center"><a href="students-regbatches_detail.php?BatchId=<?php echo $row['Id'];?>&BatchNo=<?php echo $row['BatchNo'];?>&InstituteId=<?php echo $row['InstituteId'];?>"><?php echo $row['BatchNo'];?></a></td>
							...
							<td class="center"><?php if(in_array('10',$_SESSION['emp_user_rights'])){?><a href="print_regbatches_regreturn.php?BatchId=<?php echo $row['Id'];?>&InstituteId=<?php echo $row['InstituteId'];?>"><span class="badge_style b_done">Print Report</span></a> <?php } ?></td>
						</tr>
                        <?php
						$SrNo++;
						}?>						
