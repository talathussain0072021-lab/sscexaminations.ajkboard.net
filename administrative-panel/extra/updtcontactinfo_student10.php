...
<div id="container">
	...
	if(isset($_REQUEST['rsubmit']))
	{
		...
		if(mysql_query($sql, $conn1))
		{
			...
			ActivityType			=		'ContactInfoUpdation-II',
		...
		{
			?><script>alert('Error in Query.');location.replace('updtcontactinfo_student10.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	...
	?>
	<?php
	$sql="SELECT Id, Name, FatherName, PostalAddress, PermanentAddress, PostOffice, Phone, Mobile, IsRegular FROM vwadmstudents10 WHERE Id=".$_REQUEST['Id']."";
									...
									<ul>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtcontactinfo_student10.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="6"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
									...
									<ul>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtcontactinfo_student10.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="13"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
