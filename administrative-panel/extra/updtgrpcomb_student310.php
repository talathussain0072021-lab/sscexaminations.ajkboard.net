...
<div id="container">
	...
	if(isset($_REQUEST['submit']))
	{
		...
		Sub4Code				=		'".$_REQUEST['Sub2Checkbox']."',
		Sub5Code				=		'".$_REQUEST['Sub3Checkbox']."',
		Sub6Code				=		'".$_REQUEST['Subject4Code']."',
		Sub21Code				=		'".$_REQUEST['Sub5Checkbox']."',
		Sub24Code				=		'".$_REQUEST['Sub6Checkbox']."',
		Sub25Code				=		'".$_REQUEST['Sub7Checkbox']."',
		Sub26Code				=		'".$_REQUEST['Subject8Code']."'
		...
		{
			?><script>alert('Error in Query.');location.replace('updtgrpcomb_student310.php?Id=<?php echo $_REQUEST['Id'];?>');</script><?php
		}
	}
	?>
	<?php
									...
									<ul>
											...
											<ul>
												...
												<div class="form_grid_6">
													<div class="form_input">
														...
														<div class="form_grid_6">
															<span class="input_instruction green">Click to Choose</span>
														</div>
													</div>
												</div>
												<div class="form_grid_6">
												...
												<div class="form_grid_6">
													...
													<div class="form_input">
														<div class="form_grid_6 alpha">
															<select name="Subject4Code" id="Subject4Code" data-placeholder="Select" class="chzn-select custom-select" tabindex="3">
															</select>
														</div>
													</div>
												</div>
												<div class="form_grid_6">
													...
													<div class="form_input">
														<div class="form_grid_6 alpha">
															<select name="Subject8Code" id="Subject8Code" data-placeholder="Select" class="chzn-select custom-select" tabindex="3">
															</select>
														</div>
													</div>
												</div>
										...
										<div class="form_grid_12">
											<div class="form_input">
												...
												<button type="button" name="reset" class="btn_small btn_blue" onclick="location.replace('updtgrpcomb_student310.php?Id=<?php echo $_REQUEST['Id'];?>')" tabindex="7"><span>Reset</span></button>
											</div>
										</div>
										</li>
									</ul>
...
{
	var Subject4Code=parseInt(document.getElementById('Subject4Code').value || 0);
	var Subject8Code=parseInt(document.getElementById('Subject8Code').value || 0);
	
	if(!Validate($(".form_container"))){ return false; }
	if(Subject4Code!=0 || Subject8Code!=0)
	{
		if(Subject8Code!=(Subject4Code+1)){ alert('Choose Same Subjects'); return false; }
	}//if(Subject4Code!=0 || Subject8Code!=0)
}//check_submit_form()
</script>
<script type="text/javascript" src="js/record-updation310n.js"></script>