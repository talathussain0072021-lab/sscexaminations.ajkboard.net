...
<div id="container">
	...
	if(isset($_REQUEST['submit1']))
	{
		...
		if($num_rows > 0)
		{
			...
			?><script>alert('Batch Updated Successfully.');location.replace('adm_radmbatches_add09.php');</script><?php
		}
		else
		{ ?><script>alert('Batch not Found.');location.replace('adm_radmbatches_add09.php');</script><?php }
	}//if(isset($_REQUEST['submit1']))
