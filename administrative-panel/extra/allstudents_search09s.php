					...
					<div class="widget_content">
						...
						<tr>
							...
							<td>
								...
								<option value="">Select</option>
								<?php
								$sql_batch="SELECT Id, BatchNo FROM vwadmbatches09s WHERE BatchStatus!=5 AND ExamId=".$ExamId." ORDER BY BatchNo ASC";
						...
						if(isset($_REQUEST['search']))
						{
							...
							<tr>
								...
								<td class="center"><span><a class="action-icons c-approve" href="allstudents_view09s.php?Id=<?php echo $row['Id'];?>" title="View">View</a></span></td>
							</tr>
							<?php
							$SrNo++;
							}
