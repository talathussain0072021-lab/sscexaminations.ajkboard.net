...
<div id="container">
	...
	if(isset($_REQUEST['action'])&&$_REQUEST['action']=='update-status')
	{
		if($_REQUEST['BatchStatus'] == 3)
		{
			...
			?><script>location.replace('allbatches_radm09.php?message=Data Updated Successfully.');</script><?php
	}
	?>
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						$sql="SELECT Id, Dated, BatchNo, BatchStatus, AdmStatus, RevStatus, BatchCounter, InstituteId, StdCount, BatchFee, ChallanNo FROM vwadmbatches09 WHERE BatchType=1 AND ExamId=".$ExamId." ORDER BY Id ASC";
						$res=mysql_query($sql, $conn1);
...
{
	location.replace('allbatches_radm09.php?Id='+Id+'&BatchStatus='+BatchStatus+'&InstituteId='+InstituteId+'&action=update-status');
}
</script>