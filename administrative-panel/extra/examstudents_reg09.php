...
<div id="container">
	...
	<?php
	$sql1="SELECT Id FROM vwadmstudents09 WHERE IsRegular=1 AND StdAdmStatus=1 AND SessionId=".$SessionId." AND BatchId is Not NULL";
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						{
							$SrNo=1;
							$sql="SELECT Id, Dated, Name, FatherName, PicURL, Gender, CombinationName, GroupName, BatchNo, BatchSr, ACentreCode, RegistrationNo, InstituteCode, InstituteName FROM vwadmstudents09 WHERE IsRegular=1 AND StdAdmStatus=1 AND SessionId=".$SessionId."";
