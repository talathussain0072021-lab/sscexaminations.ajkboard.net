...
$sql="SELECT Id, RollNo, Name, FatherName, Gender, ExamShift, GroupId, PicURL, IdentityMarks, BATCH_ID, ACentreCode, ACentreName, PostalAddress FROM vwrollnoslip09 WHERE RollNo!=0";
