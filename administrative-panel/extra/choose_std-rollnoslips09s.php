...
<?php
$sql="SELECT count(Id) as tstd_count FROM vwrollnoslip09s WHERE 1=1";
			...
			<div class="grid_12 full_block">
				...
				<!--<a href="voucher_print.php?id=<?php //echo $_REQUEST['id'];?>">
					...
					<div class="widget_content">
						...
						?>
						<tr height="40px">
							<td>-> <a href="print_student_allrollnoslips09s.php?StdudentId=<?php echo $_REQUEST['StdudentId'];?>&&RegNo=<?php echo $_REQUEST['RegNo'];?>&&RollNo=<?php echo $_REQUEST['RollNo'];?>&&BatchSr=<?php echo $_REQUEST['BatchSr'];?>&&Name=<?php echo $_REQUEST['Name'];?>&&CentreCode=<?php echo $_REQUEST['CentreCode'];?>&&InstituteCode=<?php echo $_REQUEST['InstituteCode'];?>&&IsRegular=<?php echo $_REQUEST['IsRegular'];?>&&first_number=<?php echo $first_number;?>&&last_number=<?php echo $last_number;?>" target="_blank">PRINT ROLLNO SLIP FROM <?php echo $first_number.'-'.$last_number;?></a></td>
						</tr>
						<?php
						}
						?>
