...
<div id="container">
	...
	<?php
	$sql1="SELECT COUNT(*) AS TotalStudents, COUNT(CASE WHEN IsPrinted=1 THEN 1 END) AS PrintedSlips FROM vwrollnoslip10c WHERE IsRegular=0";
			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						{
							$SrNo=1;
							$sql="SELECT Id, RegNo, RollNo, Name, FatherName, Gender, ExamShift, CombinationName, BATCH_ID, IsPrinted, ACentreCode, ACentreName FROM vwrollnoslip10 WHERE IsRegular=0";
							...
							<tr>
								...
								<span><a class="action-icons c-delete" href="delete_rollnoslips10.php?Id=<?php echo $row['Id'];?>&Type=0" title="Delete">Delete</a></span>
								<?php }?>
								</td>
