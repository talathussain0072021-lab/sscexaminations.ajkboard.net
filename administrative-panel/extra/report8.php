					...
					<div class="widget_content">
                		<div style="width:100%; padding:10px;">
							...
							<tr>
								...
								<a class="iframe" href="choose_print5.php?session_code=<?php echo $session_code;?>&session_title=<?php echo $session_title;?>"><span class="badge_style b_done">Print Report</span></a>
								</td>
							</tr> 
                            <tr><td colspan="4"><br></td></tr>
							</table>
